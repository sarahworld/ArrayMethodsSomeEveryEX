...
//onsole.log( hasAZero(3332123213101232321)) // true)
...
console.log(hasOnlyOddNumbers([1,2,3,5,7]))// true)
...
console.log( hasNoDuplicates([1,2,3])) // false)
...
console.log( hasCertainKey(arr,'isCatOwner')) // true)
